    ...
    success: function (response) {
      if (response["result"] === "success") {
        ...
        for (let i = 0; i < posts.length; i++) {
          ...
          let class_thumbs = post["thumbsup_by_me"]
            ? "fa-thumbs-up"
            : "fa-thumbs-o-up";
            ...
            <div class="level-left">
              ...
              >
                <span class="icon is-small">
                  <i class="fa ${class_heart}" area-hidden="true"></i></span
              ...
              >
                <span class="icon is-small">
                  <i class="fa ${class_star}" area-hidden="true"></i></span
                >&nbsp;<span class="like-num">${num2str(
                  post["count_star"]
                )}</span>
              </a>
              ...
              <a
                class="level-item is-sparta"
                aria-label="thumbs"
                onclick="toggle_thumbs('${post["_id"]}', 'thumbs')"
              >
                <span class="icon is-small">
                  <i class="fa ${class_thumbs}" area-hidden="true"></i></span
                >&nbsp;<span class="like-num">${num2str(
                  post["count_thumbs"]
                )}</span>
              </a>
